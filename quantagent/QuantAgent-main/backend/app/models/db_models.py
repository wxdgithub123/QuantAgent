...
class FactorSnapshotDB(Base):
    ...
    as_of_time = Column(DateTime(timezone=True), nullable=True)
    ...
    schema_version = Column(String(100), nullable=False, default="factor_snapshot.v1")
    parameters = Column(JSONB, nullable=False, default={})
...
class SignalEventDB(Base):
    ...
    source_strategy = Column(String(100), nullable=False, default="")
    strategy_id = Column(String(120), nullable=False, default="")
    interval = Column(String(50), nullable=True)
    provider = Column(String(100), nullable=True)
    data_source = Column(String(100), nullable=True)
    source_version = Column(String(100), nullable=True)
    schema_version = Column(String(100), nullable=False, default="signal_event.v1")
