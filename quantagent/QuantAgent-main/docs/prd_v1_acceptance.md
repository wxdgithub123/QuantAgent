...
6. Frontend/API surfaces expose status, data sources, factors, decisions, replay, and backtest.
...
[PASS] frontend_visibility: pages=/dashboard,/data-sources,/signals,/decisions,/replay,/backtest
...
The dashboard and data source management page also display this as the `PRD v1 Full Flow` panel.
...
| 10.6 Frontend and API | `/dashboard`, `/data-sources`, `/signals`, `/decisions`, `/replay`, `/backtest`, `/api/v1/system/prd-flow` |
